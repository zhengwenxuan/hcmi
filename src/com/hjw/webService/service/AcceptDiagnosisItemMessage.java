...
import com.hjw.wst.service.DataService;
	...
	public class AcceptDiagnosisItemMessage extends ServletEndpointSupport {
	   ...
	   public String acceptMessageTest(String xmlmessage){   
		   return "返回ok----临床诊疗项目字典"+xmlmessage; 
	   }
	    ...
	    * 
	        ...
	        * @throws
	    */
	    public String acceptDiagnosisItemMessage(String xmlmessage){
