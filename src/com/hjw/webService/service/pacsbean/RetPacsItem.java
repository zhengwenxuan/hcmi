...
public class RetPacsItem {
	...
	private List<RetPacsPic> listRetPacsPic =new ArrayList<RetPacsPic>();
	...
	public List<RetPacsPic> getListRetPacsPic() {
		return listRetPacsPic;
	}

	public void setListRetPacsPic(List<RetPacsPic> listRetPacsPic) {
