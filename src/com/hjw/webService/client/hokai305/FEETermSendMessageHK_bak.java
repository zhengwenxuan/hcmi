...
public class FEETermSendMessageHK_bak {
	...
	private void getString(String url,String logname){
		...
		sb.append("            <code code=\"4\" codeSystem=\"2.16.156.10011.2.3.1.271\">\n");
		...
		sb.append("              <chargeCategory value=\""+fee.getHis_num()+"\"/>\n");
		sb.append("              <!-- 收费项目名称 -->\n");
		sb.append("              <chargeDetails value=\""+fee.getItem_name()+"\"/>\n");
		sb.append("              <!-- 实收金额-->\n");
		sb.append("              <payNumber value=\""+fee.getAcc_charge()+"\"/>\n");
		sb.append("              <!--应收金额-->\n");
		sb.append("              <receivable value=\""+fee.getPrice()+"\"/>\n");
		sb.append("              <!--标准价格-->\n");
		sb.append("              <standardUnit value=\""+fee.getAcc_charge()+"\"/>\n");
		sb.append("              <!--数量-->\n");
		sb.append("              <count value=\""+fee.getCounts()+"\"/>\n");
		...
		sb.append("                    <item>\n");
		sb.append("                      <part value=\""+ei.getUser_name()+"\"/>\n");
		sb.append("                    </item>\n");
		sb.append("                  </name>\n");
		sb.append("                  <!--性别-->\n");
		...
		sb.append("                  <!--年龄(0..1)-->\n");
		sb.append("                  <originalText value=\""+ei.getAge()+"\" displayName=\"年\"/>\n");
		sb.append("                  <!-- 联系电话 (0..1)-->\n");
