...
public class RetPacsCustomeQF extends RetCustomeQF {
//	private String pacs_summary_id="";// 申请单号
	...
	private RetPacsItemQF pacsItem = new RetPacsItemQF();// 收费项目		
...
//	}
	...
	public RetPacsItemQF getPacsItem() {
		return pacsItem;
	}

	public void setPacsItem(RetPacsItemQF pacsItem) {
