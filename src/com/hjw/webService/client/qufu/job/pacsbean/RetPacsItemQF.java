...
public class RetPacsItemQF {

	private String chargingItem_num="";//项目编码
	
	private String chargingItem_name="";//项目编码
	...
	private List<RetPacsPicQF> listRetPacsPic =new ArrayList<RetPacsPicQF>();
	...
	public List<RetPacsPicQF> getListRetPacsPic() {
		return listRetPacsPic;
	}

	public void setListRetPacsPic(List<RetPacsPicQF> listRetPacsPic) {
