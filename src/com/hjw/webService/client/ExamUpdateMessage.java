...
import com.hjw.webService.client.tj180.ExamUpdateSendMessageTJ180;
 ...
 * 
     ...
     * @version V2.0.0.0
 */
public class ExamUpdateMessage {
	private ExamUpdateMessageBody lismessage;	
    private final String mesType="EXAM_UPDATE";
	public ExamUpdateMessage(ExamUpdateMessageBody lismessage){
	...
	public ResultHeader send() {
		...
		if ("1".equals(userType)) {//tj180
			ExamUpdateSendMessageTJ180 pms = new ExamUpdateSendMessageTJ180(lismessage);
