...
public class PacsBodyReqBean{
	...
	private List<PacsReqBean> itemsInfo=new ArrayList<PacsReqBean>();//项目情况
	
	public List<PacsReqBean> getItemsInfo() {
		return itemsInfo;
	}

	public void setItemsInfo(List<PacsReqBean> itemsInfo) {
