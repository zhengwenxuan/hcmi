 ...
 * 
     ...
     * @version V2.0.0.0
 */
public class DAHEDITSendMessageFZ{
	...
	private String getSendMessage(DAHCustomerBean eu) {
		...
		sb.append("<id>");
		sb.append("<item extension=\"1\" root=\"1.2.156.112685.1.1.1.3.1\" identifierName=\"\"/>");//患者EMPI标识
		sb.append("<item extension=\"2\" root=\"1.2.156.112685.1.1.2.2.1.2\" identifierName=\"\"/>");//住院号
		sb.append("<item extension=\"3\" root=\"1.2.156.112685.1.1.2.2.1.12\" identifierName=\"\"/>");//门诊号
		sb.append("<item extension=\"4\" root=\"1.2.156.112685.1.1.2.2.1.11\" identifierName=\"\"/>");//医保号
		sb.append("<item extension=\"5\" root=\"1.2.156.112685.1.1.2.2.1.2\" identifierName=\"\"/>");//域ID(门诊、住院)
		sb.append("<item extension=\"6\" root=\"1.2.156.112685.1.2.1.4.1\" identifierName=\"\"/>");//患者ID
		sb.append("</id>");
		...
		sb.append("<id>");
		sb.append("<item extension=\""+eu.getId_num()+"\" root=\"1.2.156.112685.1.1.2.2.1.8\" controlInformationExtension=\"身份证号\"/>");
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.2.1.9\" controlInformationExtension=\"居民户口簿\"/>");//
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.2.1.10\" controlInformationExtension=\"护照\"/>");
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.2.1.11\" controlInformationExtension=\"军官证\"/>");
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.2.1.12\" controlInformationExtension=\"驾驶证\"/>");
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.2.1.13\" controlInformationExtension=\"港澳居民来往内地通行证\"/>");
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.2.1.14\" controlInformationExtension=\"台湾居民来往内地通行证\"/>");
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.2.1.15\" controlInformationExtension=\"其他法定有效证件\"/>");
		sb.append("</id>");
		//<!--姓名 必须项已使用-->
		...
		sb.append("</name>");
		//<!-- 性别代码 -->
		sb.append("<administrativeGenderCode code=\"1\" codeSystem=\"1.2.156.112685.1.1.2.1.2.1\" codeSystemName=\""+eu.getSex()+"\"/>");
		//<!-- 出生日期 -->
				Date bridd = DateTimeUtil.parse(eu.getBrid());
				String brids = DateTimeUtil.shortFmt5(bridd);
		sb.append("<birthTime value=\""+brids+"\"/>");
		//<!-- 婚姻状况类别代码 -->
		sb.append("<maritalStatusCode code=\"10\" codeSystem=\"1.2.156.112685.1.1.2.1.2.2\" codeSystemName=\"\"/>");
		//<!-- 文化程度代码 -->
		sb.append("<educationLevelCode code=\"\" codeSystem=\"1.2.156.112685.1.1.2.1.3.9\" codeSystemName=\"\"/>");
		//<!--民族代码 -->
		sb.append("<ethnicGroupCode>");
		sb.append("<item code=\"TJ\" codeSystem=\"1.2.156.112685.1.1.2.1.2.3\" codeSystemName=\""+eu.getNation()+"\"/>");
		sb.append("</ethnicGroupCode>");
		//<!--雇佣关系 -->
		...
		sb.append("</telecom>");
			//<!--职业编码系统名称/职业代码 -->
		sb.append("<occupationCode code=\"\" codeSystem=\"1.2.156.112685.1.1.2.1.2.5\" codeSystemName=\"\"/>");
			//<!-- 必须项未使用 -->
			//<!--工作单位 -->
		...
		sb.append("<code code=\"\" codeSystem=\"1.2.156.112685.1.1.2.1.2.4\" codeSystemName=\"\"/>");
			//<!-- 国家名称 -->
		sb.append("<name>");
		sb.append("<part value=\"\"/>");
		sb.append("</name>");
		...
		//<!-- 与患者关系 -->
		sb.append("<id>");
		sb.append("<item extension=\"12\" root=\"1.2.156.112685.1.1.2.1.3.10\" identifierName=\"\"/>");
		sb.append("</id>");
		//<!-- 联系人地址 -->
		sb.append("<addr xsi:type=\"BAG_AD\">");
		//	<!--通用联系地址（如果只有一个地址:保留type="AL"项目，删除type="CTY"项目；如果有两个地址:参考如下形式） -->
		...
		sb.append("<id>");
		sb.append("<item extension=\"\" root=\"1.2.156.112685.1.1.2.1.4.2\" identifierName=\"\" />");
		sb.append("</id>");
