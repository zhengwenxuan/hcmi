...
public class WebServiceLocator extends org.apache.axis.client.Service implements com.hjw.webService.client.sinosoft.server.WebService {
    ...
    private java.lang.String WebServiceSoap_address = "http://10.10.10.74/PiasInterface/WebService.asmx";
    ...
    public com.hjw.webService.client.sinosoft.server.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hjw.webService.client.sinosoft.server.WebServiceSoapStub _stub = new com.hjw.webService.client.sinosoft.server.WebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hjw.webService.client.sinosoft.server.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hjw.webService.client.sinosoft.server.WebServiceSoapStub _stub = new com.hjw.webService.client.sinosoft.server.WebServiceSoapStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://client.integrator.application.sinosoft.com", "WebService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://client.integrator.application.sinosoft.com", "WebServiceSoap"));
        }
