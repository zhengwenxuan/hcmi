 ...
 * 
     ...
     * @version V2.0.0.0
 */
public class LISDELSendMessageBDYX_UseCode {
	...
	public LISDELSendMessageBDYX_UseCode(LisMessageBody lismessage){
	...
	private String updateSampleExamDetailByExamid(long examid, String sample_barcode, String status, String logname) throws ServiceException {
		String barcode_new = batchService.GetCreateID("barcode");
		...
		TranLogTxt.liswriteEror_to_txt(logname, "更新条码号："+sql);
