...
public class CUSTOMEditSendMessageHK {
	...
	public CUSTOMEditSendMessageHK(Custom custom){
		this.custom=custom;
	}
			...
			try {				
				...
				if("AA".equals(rcb.getCode())){
					this.custom.setPATIENT_ID(rcb.getPersionid());
						setSearchString(url,"update",logname);
	...
	private void setSearchString(String url,String statusCode,String logname){
		...
		sb0.append("			<!-- item root=\"接收者ID\" extension=\"接受机构\" -->   ");
		sb0.append("			<id> ");
		...
		sb0.append("				<statusCode code=\"update\"/>");
		...
		sb0.append("								<occupationCode code=\"\" codeSystem=\"2.16.156.10011.2.3.3.7\" codeSystemName=\"职业代码\" displayName=\"专业技术人员\" />");
	...
	private ResCustomBeanHK searchPatid(String url,String logname){	
		...
		sb0.append("  </sender>"); 
		sb0.append("  <controlActProcess classCode=\"CACT\" moodCode=\"EVN\">"); 
		sb0.append("    <code code=\"PRPA_TE201305UV02\" codeSystem=\"2.16.840.1.113883.1.6\"/>  "); 
		...
		sb0.append("        <code code=\"04\" codeSystem=\"2.16.156.10011.2.3.1.271\"> "); 
