...
public class ResPacsMessageHK {
	private RetPacsCustome rc= new RetPacsCustome();
	private Document document;
	public ResPacsMessageHK(String xmlmessage,boolean flags) throws Exception{
		 String xmlmessagess="";
		 if(flags){
...
//			this.getdoctor_effectiveTime();//获取报告时间
	...
	public void getCustom() throws Exception {
		String exam_num= document.selectSingleNode("abc:RCMR_IN000002UV02/abc:controlActProcess/abc:subject/abc:clinicalDocument/abc:recordTarget/abc:patientRole/abc:patient/abc:id/abc:item/@extension").getText();// 获取根节点
	...
	public void getdoctor_bg() throws Exception {		
		...
		String name = document.selectSingleNode("abc:RCMR_IN000002UV02/abc:controlActProcess/abc:subject/abc:clinicalDocument/abc:participant/abc:associatedEntity/abc:associatedPerson/abc:name").getText();// 获取根节点
	...
	public void getdoctor_orderid() throws Exception {
		String time = document.selectSingleNode("abc:RCMR_IN000002UV02/abc:controlActProcess/abc:subject/abc:clinicalDocument/abc:recordTarget/abc:patientRole/abc:id/abc:checkAppId/@extension").getText();// 获取根节点
	...
	private void getNodes_doctor_Item() throws Exception {		
		...
		RetPacsItem reti=new RetPacsItem();
			String  Items_code = document.selectSingleNode("abc:RCMR_IN000002UV02/abc:controlActProcess/abc:subject/abc:clinicalDocument/abc:component/abc:structuredBody/abc:component/abc:section/abc:entry1/abc:organizer/abc:component/abc:observation/abc:code/@code").getText();// 获取根节点
			reti.setChargingItem_num(Items_code);
			String Itemsitem = document.selectSingleNode("abc:RCMR_IN000002UV02/abc:controlActProcess/abc:subject/abc:clinicalDocument/abc:component/abc:structuredBody/abc:component/abc:section/abc:entry1/abc:organizer/abc:component/abc:observation/abc:value[@code='01']/abc:originalText").getText();// 获取根节点
			reti.setChargingItem_ms(Itemsitem);
			String Itemsitemjl = document.selectSingleNode("abc:RCMR_IN000002UV02/abc:controlActProcess/abc:subject/abc:clinicalDocument/abc:component/abc:structuredBody/abc:component/abc:section/abc:entry1/abc:organizer/abc:component/abc:observation/abc:value[@code='02']/abc:originalText").getText();// 获取根节点
