 ...
 * 
     ...
     * @version V2.0.0.0
 */
public class DELFEESendMessageHK {

	private DelFeeMessage feeMessage;
	private static JdbcQueryManager jdbcQueryManager;
	private static ConfigService configService;
	public DELFEESendMessageHK(DelFeeMessage feeMessage){
	...
	private ResultHeader  getString(String url,String logname){
		...
		sb.append("  <!-- 消息的服务标识-->\n");//
		sb.append("  <interactionId extension=\"S0072\" root=\"2.16.840.1.113883.1.6\"/>\n");
