...
public class PACSDelSendMessageNF {
	...
	public PACSDelSendMessageNF(PacsMessageBody lismessage) {
	...
	public ResultPacsBody getMessage(String url,String logname){
		...
		try {
			...
			for (int i = 0; i < components.size(); i++) {
				...
				reqStr = NanfenHL7.OrmO01hl7_cancelPacs(lismessage, liscoms, i, "CA", logname, guid);// NW
