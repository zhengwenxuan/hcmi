 ...
 * 
     ...
     * @version V2.0.0.0
 */
public class ExamDeleteMessage {
	private ExamDeleteMessageBody lismessage;	
    private final String mesType="EXAMG_DELETE";
	public ExamDeleteMessage(ExamDeleteMessageBody lismessage){
	...
	public ResultHeader send() {
		...
		if ("1".equals(userType)) {//tj180
			ExamDelSendMessageTJ180 pms = new ExamDelSendMessageTJ180(lismessage);
