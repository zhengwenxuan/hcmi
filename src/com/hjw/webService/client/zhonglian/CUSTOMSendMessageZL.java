 ...
 * 
     ...
     * @version V2.0.0.0
 */
public class CUSTOMSendMessageZL {
	...
	public CUSTOMSendMessageZL(Custom custom){
		this.custom=custom;
	}
					...
					try {
						...
						try {
							...
							TranLogTxt.liswriteEror_to_txt(logname, "res:Zl_NewPatient-" + exam_id + "-Zl_NewPatient('"+this.custom.getNAME()+"','"+this.custom.getSEX()+"','"
									+this.custom.getAGE()+"','"+(this.custom.getCLINIC_NO()==null?"":this.custom.getCLINIC_NO())+"','','"+eu.getId_num()+"','"
											+eu.getPhone()+"','"+eu.getAddress()+"','"+eu.getIs_marriage()+"','"+eu.getCompany()+"'"
													+ ",'"+this.custom.getEXAM_NUM()+"',?,?,?)");
							
							c.setString(1, this.custom.getNAME());
							c.setString(2, this.custom.getSEX());
							c.setString(3, this.custom.getAGE());
							c.setString(4, this.custom.getCLINIC_NO()==null?"":this.custom.getCLINIC_NO());
							c.setString(5, "");
