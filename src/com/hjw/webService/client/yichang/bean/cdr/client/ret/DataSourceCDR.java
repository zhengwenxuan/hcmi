...
public class DataSourceCDR {

	private Document document;
	private String message;
	private String status;

	public DataSourceCDR(String xmlmessage,boolean flags) throws Exception{
		String xmlmess="";
		if(flags){
			xmlmess=xmlmessage;
		}else{
		...
		Node node = document.selectSingleNode("/DataSource/return/message");
		if(node != null) {
			this.message = node.getText();
		}
		node = document.selectSingleNode("/DataSource/return/status");
		if(node != null) {
	...
	public static void main(String[] args) throws Exception {
		System.out.println(new DataSourceCDR("", false).getStatus());
	}
}
