...
public class RetPacsCustomeHJ extends RetCustome {
	...
	private RetPacsItemHJ pacsItem = new RetPacsItemHJ();// 收费项目		
	...
	public RetPacsItemHJ getPacsItem() {
		return pacsItem;
	}

	public void setPacsItem(RetPacsItemHJ pacsItem) {
